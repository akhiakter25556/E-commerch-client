    ...
    <section className="py-16 px-6 bg-gray-50">
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className="text-gray-600 text-lg md:text-xl">
          Explore some of our premium cars and products. Quality and style combined.
        </p>
      </div>
          ...
          >
            <img
              ...
              className="w-full h-64 object-cover transition-transform duration-300
               hover:scale-105"
            />
            <div className="absolute inset-0 bg-black bg-opacity-20 opacity-0
             hover:opacity-100 transition flex items-center justify-center">
              <Link
                href={img}
                className="px-4 py-2 bg-purple-700 text-white rounded-lg
                 shadow-lg hover:bg-purple-800 transition"
              >
                View
              </Link>
            </div>
