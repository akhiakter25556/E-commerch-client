    ...
    <nav className="sticky top-0 bg-white shadow-md z-50">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div className="hidden md:flex items-center gap-8 font-medium text-gray-700">
          ...
          <Link href="/itemlist" className="hover:text-purple-700">Item</Link>
...
>
  Profile
                ...
                className="block px-4 py-2 hover:bg-purple-100">Add Product</Link>
                <Link href="/manage-products" 
                className="block px-4 py-2 hover:bg-purple-100">Manage Products</Link>
                <button
      ...
      {openMenu && (
        <div className="md:hidden bg-white shadow-inner border-t p-6 space-y-4">
          ...
          hover:text-purple-700">Contact</Link>
          <Link href="/itemlist" className="block text-lg font-medium
           hover:text-purple-700">Items</Link>
<Link href="/gallery" className="block px-2 py-1 hover:bg-purple-100 rounded">Profile</Link>
          ...
          <div className="relative">
            ...
            {openDropdown && (
              <div className="bg-white border rounded-lg shadow p-4 space-y-2 mt-2">
                <Link href="/profile" className="block px-2 py-1
                 hover:bg-purple-100 rounded">Profile</Link>
                <Link href="/add-product" className="block px-2 py-1
                 hover:bg-purple-100 rounded">Add Product</Link>
                <Link href="/manage-products" className="block px-2 py-1
                 hover:bg-purple-100 rounded">Manage Products</Link>
                <button
                  onClick={() => signOut({ callbackUrl: "/login" })}
